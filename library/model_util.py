...
def convert_ldm_clip_checkpoint_v1(checkpoint):
    ...
    if "text_model.embeddings.position_ids" not in text_model_dict:
        text_model_dict["text_model.embeddings.position_ids"] = torch.arange(77).unsqueeze(
            0)  # 77 is the max length of the text
...
def load_models_from_stable_diffusion_checkpoint(v2, ckpt_path, device="cpu", dtype=None,
    ...
    if v2:
        ...
        text_model_path_local = 'E:\\sinri\\HuggingFace\\clip-vit-large-patch14'
        if os.path.isdir(text_model_path_local):
            text_model_path = text_model_path_local
        else:
            text_model_path = "openai/clip-vit-large-patch14"
